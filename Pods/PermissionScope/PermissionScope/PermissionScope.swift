...
@objc public class PermissionScope: UIViewController, CLLocationManagerDelegate, UIGestureRecognizerDelegate, CBPeripheralManagerDelegate {
    ...
    public var closeButtonTextColor        = UIColor(red: 1, green: 1, blue: 1, alpha: 0.5)
    /// Color for the permission buttons' text color.
    public var permissionButtonTextColor   = UIColor(red: 1, green: 1, blue: 1, alpha: 1)
    ...
    public var permissionLabelColor:UIColor = .whiteColor()
    ...
    */
    public init(backgroundTapCancels: Bool) {
        ...
        // Content View
        contentView.backgroundColor = UIColor(red: 50/255, green: 50/255, blue: 70/255, alpha: 1)
        ...
        headerLabel.text = "Hold up!".localized
		...
		bodyLabel.text = "Please enable notifications".localized
