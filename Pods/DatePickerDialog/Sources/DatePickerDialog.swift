...
public class DatePickerDialog: UIView {
	...
	func setupView() {
		...
		self.backgroundColor = UIColor(red: 50/255, green: 50/255, blue: 60/255, alpha: 0)
	...
	public func show(title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", defaultDate: NSDate = NSDate(), minimumDate: NSDate? = nil, maximumDate: NSDate? = nil, datePickerMode: UIDatePickerMode = .DateAndTime, callback: DatePickerCallback) {
		...
		UIView.animateWithDuration(
			...
			animations: { () -> Void in
				self.backgroundColor = UIColor(red: 50/255, green: 50/255, blue: 60/255, alpha: 0.4)
	...
	private func createContainerView() -> UIView {
		...
		gradient.colors = [UIColor(red: 50/255, green: 50/255, blue: 70/255, alpha: 1).CGColor,
		                   UIColor(red: 70/255, green: 70/255, blue: 90/255, alpha: 1).CGColor,
		                   UIColor(red: 50/255, green: 50/255, blue: 70/255, alpha: 1).CGColor]
	...
	private func addButtonsToView(container: UIView) {
		...
		self.cancelButton.setTitleColor(UIColor(red: 1, green: 1, blue: 1, alpha: 1), forState: UIControlState.Normal)
		self.cancelButton.setTitleColor(UIColor(red: 1, green: 1, blue: 1, alpha: 0.5), forState: UIControlState.Highlighted)
		...
		self.doneButton.setTitleColor(UIColor(red: 1, green: 1, blue: 1, alpha: 1), forState: UIControlState.Normal)
		self.doneButton.setTitleColor(UIColor(red: 1, green: 1, blue: 1, alpha: 0.5), forState: UIControlState.Highlighted)
